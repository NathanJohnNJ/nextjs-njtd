...
const GitHub = () => {
  ...
  return(
     ...
     <button className="Btn" id="gitHub" onMouseEnter={()=>setVisibility("visible")} onMouseLeave={()=>setVisibility("hidden")}>
       <span className="svgContainer">
       <svg className="socialSvg" fill="white" viewBox="0 0 496 512" height="1.6em">
