...
const ThirdSection = () => {
  ...
  return(
    <motion.div ref={ref} className="relative h-[800vh] w-[90vw] flex flex-col self-center mb-[50vh] justify-self-center items-center justify-flex-end mt-[45vh]">
      <motion.div className="sticky top-[10vh] w-[85%] flex flex-col p-16">    
