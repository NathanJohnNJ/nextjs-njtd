    ...
    <div className="h-[150vh] text-[var(--mid-color)] ">
      ...
      <div className="flex flex-col justify-center items-center">
            ...
            <div className="flex justify-center flex-col items-start text-left text-base ">
              <p className="text-2xl font-[poppins] font-semibold"><strong>Name:</strong> Nathan John</p>
          ...
          <h2 className="flex self-center text-xl text-center font-[poppins] font-semibold text-[var(--mid-color)] justify-self-center ml-[20vw]">Date updated: 21/05/25</h2>
        </div>
        </div>
    </div>
  )
